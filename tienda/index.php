...
<div class="container">
	<div class="row">
		...
		<div class="row gx-4 gx-lg-3 row-cols-1 row-cols-md-2 row-cols-lg-3 justify-content-center">
			...
			?>
					<div class="col mb-5 d-flex justify-content-center container mt-5">
						<div class="card h-100 p-3 bg-white">
							<a href="#"><img class="card-img-top" src="./img/productes/<?php echo $row_prod['url_foto']; ?>" alt=""></a>
							<div class="card-body mt-2 about-product text-center">
							...
							<div class="card-footer p-4 pt-0 border-top-0 bg-transparent stats mt-2">
								<div class="text-center"><a class="btn btn-outline-dark mt-auto bgButton fill" href="https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=sandra%40hotmail%2ecom&lc=ES&item_name=<?php echo $row_prod['nombre']; ?>&amount=<?php echo $row_prod['precio']; ?>&currency_code=EUR&button_subtype=services&no_note=0&bn=PP%2dBuyNowBF%3abtn_buynowCC_LG%2egif%3aNonHostedGuest" target="_blank">Comprar</a></div>
							</div>
